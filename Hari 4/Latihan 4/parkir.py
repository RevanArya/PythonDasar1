...
class UIandFunction:
    ...
    def frameTop(self, root, Basecolor):
        ...
        lb_title = Label(frameleft, text="APLIKASI PARKIR REVAN ARYA", bg=Basecolor, fg="#213555")
        lb_title.config(font=("Helvetica", 15, BOLD))
        lb_title.pack()
        ...
        lb_table1 = Label(frameleft, text="List Pelanggan Urut Terakhir Keluar", bg=Basecolor, fg="#4F709C")
        ...
        lb_title_bayar = Label(frameright, text="Biaya Parkir Per Jam", fg="#4F709C", bg=Basecolor)
        lb_title_bayar.config(font=("Helvetica", 12, BOLD))
        lb_title_bayar.place(x=0, y=70)
        lb_bayar = Label(frameright, text="Rp 2.000", fg="#213555", bg=Basecolor)
        lb_bayar.config(font=("Helvetica", 42, BOLD))
        lb_bayar.place(x=0, y=90)
        lb_table2 = Label(frameright, text="List Pelanggan Banyak Bayar", bg=Basecolor, fg="#4F709C")
    ...
    def tableGrid(self, indikator, frame, data_list):
        ...
        for i in range(len(data_list_update)):
            for j in range(len(data_list_update[0])):
                e = Entry(frame, width=12, fg='#4F709C', font=('Arial', 10, 'bold'))
